...
nearest_aed_url = 'https://aed.azure-mobile.net/api/AEDSearch?lat=36.53247&lng=136.63104&r=500'
nearest_aed_data = requests.get(geo_request_url).json()
print('\n' + nearest_aed_data)
# print(nearest_aed_data['DIST'])
# NEAREST_AED_DIST = 0
NEAREST_AED_DIST = ()
print('nearest_aed_dist =' + NEAREST_AED_DIST)
